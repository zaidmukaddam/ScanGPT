                    ...
                    Positioned(
                      ...
                      child: BlocListener<DetectorCubit, DetectorState>(
                        listenWhen: (previous, current) {
                          return previous.userInput.value !=
                ...
                child: BlocBuilder<DetectorCubit, DetectorState>(
                  ...
                  builder: (context, state) {
                    return NeoPopTiltedButton(
                      ...
                      onTapUp: state.status.isValidated && !state.status.isSubmissionInProgress
                          ? () => context
                              .read<DetectorCubit>()
                              .detectionRequested(text: state.userInput.value)
                          : null,
